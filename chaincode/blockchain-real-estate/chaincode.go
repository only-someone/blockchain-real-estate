...
func (t *BlockChainRealEstate) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
	...
	case "queryTypeResources":
		return routers.QueryTypeResources(stub, args)
	case "queryDemand":
		return routers.QueryDemand(stub, args)
	case "queryNoSolution":
		return routers.QueryNoSolution(stub, args)
